...
{
    /// <inheritdoc />
    public partial class AddQuizAndAchievements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCertificates_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCertificates_CourseId",
                table: "UserCertificates",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCertificates_UserId_CourseId",
                table: "UserCertificates",
                columns: new[] { "UserId", "CourseId" },
                unique: true);
